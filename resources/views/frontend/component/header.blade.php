            ...
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <div class="sitelink">
                    <ul class="uk-list uk-clearfix uk-flex uk-flex-middle">
                        ...
                        @foreach ($menu['menu-sidebar'] as $key => $val)
                        @php
                ...
                <div class="header-widget">
                    <div class="uk-flex uk-flex-middle">
                       ...
                       @if (isset($language))
                       <div class="language">
                        <a href="" class="active">{{$language->first()->name}}</a>
                ...
                <div class="middle-widget">
                    <div class="uk-flex uk-flex-middle">
                        ...
                        <div class="widget-toolbox uk-flex uk-flex-middle">
                            ...
                            <div class="toolbox-item uk-flex uk-flex-middle">
                                @if (!is_null($customer))
                                    <span ><img src="{{asset($customer->image)}}" alt="" class="avatar"></span>
                                @else
                                ...
                                @endif
                                <div class="navigation ms-0">
                                    <ul class="uk-list uk-clearfix uk-navbar-nav main-menu">
                                      
                                        
                                        <li class="children toolbox-text"><a href="" title="">{{ (!is_null($customer)) ? $customer->name : 'Đăng nhập'  }}</a>
                                        <div class="dropdown-menu">

                                            @if (!is_null($customer))
                                            <ul class="uk-list uk-clearfix menu-style " >
                                                <li><a href="{{route('customer.profile',['id'=> $customer->id])}}">Hồ sơ</a></li>
                                                <li><a href="{{route('order.history',['id'=> $customer->id])}}">Đơn hàng</a></li>
                                                
                                                <li>
                                                    <form action="{{ route('customer.logout') }}" method="POST">
                                                        @csrf
                                                        <button type="submit" class="uk-button uk-button-link uk-text-danger">
                                                            Đăng xuất
                                                        </button>
                                                    </form>
                                                </li>
                                            ...
                                            @else
                                            <ul class="uk-list uk-clearfix menu-style " >
                                                <li><a href="{{route('customer')}}">Đăng Nhập</a></li>
                                                <li><a href="{{route('customerfe.create')}}">Đăng ký</a></li>
